  ...
  return (
    <section className="border-b border-border">
      <div className="container max-w-4xl py-16 md:py-24">
        ...
        <h2 className="mt-3 max-w-3xl whitespace-pre-line font-heading text-3xl font-bold leading-tight text-cream md:text-4xl lg:text-5xl text-balance">
          {about.title}
        </h2>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {forWhom.items.map((item, i) => (
            ...
            >
              ...
              <h3 className="mt-3 font-heading text-lg font-semibold text-cream">
                {item.title}
              </h3>
  ...
  return (
    <section className="border-b border-border">
      <div className="container max-w-4xl py-16 md:py-24">
        ...
        <h2 className="mt-3 whitespace-pre-line font-heading text-3xl font-bold leading-tight text-cream md:text-4xl text-balance">
          {speakers.title}
        </h2>
        ...
        {speakers.note && (
          <p className="mt-8 max-w-2xl font-sans text-sm text-cream-40">
            {speakers.note}
          </p>
        )}
      </div>
      ...
      <div className="container max-w-4xl py-16 md:py-24">
        ...
        <ol className="mt-10 max-w-2xl space-y-5">
          {format.schedule.map((item, i) => (
            <li
              key={i}
              className="grid grid-cols-[80px_1fr] gap-5 border-l-2 border-gold/30 pl-5"
            >
      ...
      <div className="container max-w-4xl py-16 md:py-24">
        ...
        <dl className="mt-8 grid max-w-3xl gap-8 md:grid-cols-2">
          {faq.items.map((item, i) => (
            <div key={i}>
              <dt className="font-heading text-lg font-semibold text-cream">
                {item.q}
              </dt>
              <dd className="mt-2 font-sans text-sm leading-relaxed text-cream-70">
                {item.a}
              </dd>
            </div>
          ))}
